...
// test to see if the enqueue is correct. 
int unitTest6(int status){ 
    ...
    stack_enqueue(test_s, 5);
    stack_enqueue(test_s, 10);
    stack_enqueue(test_s, 11);
    stack_enqueue(test_s, 4);
    stack_enqueue(test_s, 0);
    stack_enqueue(test_s, 9);
    stack_enqueue(test_s, 15);
    stack_enqueue(test_s, 100);
    stack_enqueue(test_s, 4000);
    stack_enqueue(test_s, 999);
...
// test to see if the stack_full return correct. 
int unitTest7(int status){
    int passed = 0;

    stack_t *test_s = create_stack(4);
    stack_enqueue(test_s, 1);
    stack_enqueue(test_s,4);
    stack_enqueue(test_s, 5);
    stack_enqueue(test_s, 6);
...
//test to see if the dequeue and enqueue works both correct. 
